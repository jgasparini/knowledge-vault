...
| `wiki-lint` | "Lint the wiki" or "Wiki health check" | 11-check structural health pass with auto-fixes |
...
| `improve-system` | "Audit notes", "improve that skill", "capture this experience", "mine my sessions", "fill in about me", or "regression check" | 6-mode meta-maintenance: Audit / Skill Review / Experience / Historical Review / Foundation / Regression Check |
